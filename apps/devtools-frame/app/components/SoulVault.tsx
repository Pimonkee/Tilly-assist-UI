    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleCreate} className="space-y-2 bg-slate-900/70 border border-slate-800 rounded-lg p-3">
        <input 
          ...
          className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-sm mb-1 text-slate-200"
          value={title}
          onChange={(e) => setTitle(e.target.value)}
        />
        <textarea 
          placeholder="Write a thought only future-you can read..."
          className="w-full h-24 bg-slate-950 border border-slate-700 rounded px-2 py-1 text-sm mb-1 text-slate-200"
          value={content}
